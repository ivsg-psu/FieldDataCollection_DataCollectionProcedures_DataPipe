% script_test_fcn_DataPipe_mainDataPipeMenu.m
% tests fcn_DataPipe_mainDataPipeMenu.m
...
% 
% % Call the function
% fcn_DataPipe_mainDataPipeMenu(thisSourceFolderName, thisDestinationFolder, ([]));
% 
% sgtitle(titleString, 'Interpreter','none');
% 
% % Check variable types
...
% 
% % Call the function
% fcn_DataPipe_mainDataPipeMenu(thisSourceFolderName, thisDestinationFolder, (-1));
% 
% sgtitle(titleString, 'Interpreter','none');
% 
% % Check variable types
