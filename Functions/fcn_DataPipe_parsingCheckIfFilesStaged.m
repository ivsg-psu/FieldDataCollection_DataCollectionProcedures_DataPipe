function fcn_DataPipe_parsingCheckIfFilesStaged(directoryUnsortedBags, directoryRawBags, varargin)
...
%
%      directoryRawBags: a string containing the path of the 
...
% EXAMPLES:
%
%     See the script: script_test_fcn_DataPipe_parsingCheckIfFilesStaged
...
if 0==flag_max_speed
    if flag_check_inputs
        ...
        % 
        % % Check the directoryRawBags to be sure it is an existing
        % % directory
        % fcn_DebugTools_checkInputsToFunctions(directoryRawBags, 'DoesDirectoryExist');
...
fcn_DataPipe_helperConfirmDirectoryExists(directoryRawBags, (1), (-1));
