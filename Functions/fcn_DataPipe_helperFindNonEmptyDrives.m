function nonEmptyInfoTable = fcn_DataPipe_helperFindNonEmptyDrives(varargin)

%fcn_DataPipe_helperFindNonEmptyDrives
%     returns a table of non-empty available drives
%
% FORMAT:
%
...
% OUTPUTS:
%
%      nonEmptyInfoTable: an infoTable that excludes non-empty values
%
% DEPENDENCIES:
%
...
% EXAMPLES:
%
%     See the script: script_test_fcn_DataPipe_helperFindNonEmptyDrives
...
% Use this section to save test data - BE SURE TO UPDATE CASE NUMBER and
...
if ispc
    ...
    notEmptyName = isNotEmpty;
end

nonEmptyInfoTableRows = (isNotEmpty.*notEmptyName)==1;
nonEmptyInfoTable = infoTable(nonEmptyInfoTableRows,:);
