% script_test_fcn_DataPipe_processOneFigFile.m
% tests fcn_DataPipe_processOneFigFile.m
...
thisSourceFolderName = fullfile(pwd,'Data','processOneFigFile','From');
thisDestinationFolder = fullfile(pwd,'Data','processOneFigFile','To');
...
% Call the function
fcn_DataPipe_processOneFigFile(thisSourceFolderName, thisDestinationFolder, ([]));
...
% Call the function
fcn_DataPipe_processOneFigFile(thisSourceFolderName, thisDestinationFolder, (-1));
