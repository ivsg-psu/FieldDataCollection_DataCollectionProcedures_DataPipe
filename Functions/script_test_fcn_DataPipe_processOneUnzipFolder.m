% script_test_fcn_DataPipe_processOneUnzipFolder.m
% tests fcn_DataPipe_processOneUnzipFolder.m
...
% 
% % Call the function
% fcn_DataPipe_processOneUnzipFolder(thisSourceFullFolderName, destinationRootOrSubroot, (-1));
% 
% sgtitle(titleString, 'Interpreter','none');
% 
% % Check variable types
