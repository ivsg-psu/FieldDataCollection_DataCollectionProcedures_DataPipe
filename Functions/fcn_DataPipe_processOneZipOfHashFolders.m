function fcn_DataPipe_processOneZipOfHashFolders(thisSourceFullFolderName, destinationRootOrSubroot, varargin)
%% fcn_DataPipe_processOneZipOfHashFolders
% Zips all 2nd-layer and below folders within a hash table
%
% FORMAT:
%
...
% EXAMPLES:
%
%     See the script: script_test_fcn_DataPipe_processOneZipOfHashFolders
