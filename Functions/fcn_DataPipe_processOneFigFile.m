function fcn_DataPipe_processOneFigFile(thisSourceFullFolderName, thisDestinationFolder, varargin)
%% fcn_DataPipe_processOneFigFile
% Creates fig files from MAT files in a source folder, putting results in a
% destination folder
%
% FORMAT:
%
%      fcn_DataPipe_processOneFigFile(thisSourceFolderName, thisDestinationFolder, (figNum));
%
% INPUTS:
%
%      thisSourceFolderName: a string containing the path of the 
%      directory containing the unmerged mat files.
%
%      thisDestinationFolder: a string containing the path of the 
...
%     fcn_LoadRawDataToMATLAB_loadMatDataFromDirectories
%     fcn_LoadRawDataToMATLAB_identifyDataByScenarioDate
%     fcn_LoadRawDataToMATLAB_plotRawDataPositions
%
% EXAMPLES:
%
%     See the script: script_test_fcn_DataPipe_processOneFigFile
