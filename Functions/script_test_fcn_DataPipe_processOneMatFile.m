% script_test_fcn_DataPipe_processOneMatFile.m
% tests fcn_DataPipe_processOneMatFile.m
...
thisSourceFolderName = fullfile(pwd,'Data','processOneMatFile','From');
thisDestinationFolder = fullfile(pwd,'Data','processOneMatFile','To');
...
% Call the function
fcn_DataPipe_processOneMatFile(thisSourceFolderName, thisDestinationFolder, (figNum));
...
% Call the function
fcn_DataPipe_processOneMatFile(thisSourceFolderName, thisDestinationFolder, ([]));
...
% Call the function
fcn_DataPipe_processOneMatFile(thisSourceFolderName, thisDestinationFolder, (-1));
