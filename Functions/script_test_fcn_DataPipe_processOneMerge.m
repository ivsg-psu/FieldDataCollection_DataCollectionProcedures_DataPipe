% script_test_fcn_DataPipe_processOneMerge.m
% tests fcn_DataPipe_processOneMerge.m
...
thisSourceFolderName = fullfile(pwd,'Data','processOneMerge','From');
thisDestinationFolder = fullfile(pwd,'Data','processOneMerge','To');
...
% Call the function
fcn_DataPipe_processOneMerge(thisSourceFolderName, thisDestinationFolder, (figNum));
...
% Call the function
fcn_DataPipe_processOneMerge(thisSourceFolderName, thisDestinationFolder, ([]));
...
% Call the function
fcn_DataPipe_processOneMerge(thisSourceFolderName, thisDestinationFolder, (-1));
