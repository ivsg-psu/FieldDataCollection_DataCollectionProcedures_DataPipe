% script_test_fcn_DataPipe_processOneZipOfHashFolders.m
% tests fcn_DataPipe_processOneZipOfHashFolders.m
...
% 
% 
% thisSourceFullFolderName = fullfile(pwd,'Data','processOneMerge','From');
% destinationRootOrSubroot = fullfile(pwd,'Data','processOneMerge','To');
% 
% if exist(destinationRootOrSubroot,'dir')
%     [SUCCESS,~,~] = rmdir(destinationRootOrSubroot,'s');
%     if ~SUCCESS
...
% 
% % Call the function
% fcn_DataPipe_processOneZipOfHashFolders(thisSourceFullFolderName, destinationRootOrSubroot, (figNum));
% 
% sgtitle(titleString, 'Interpreter','none');
% 
% % Check variable types
% assert(exist(destinationRootOrSubroot,'dir'));
% 
% % Check variable sizes
% temp = dir(destinationRootOrSubroot);
% assert(length(temp)==14);
% 
...
% 
% % Call the function
% fcn_DataPipe_processOneZipOfHashFolders(thisSourceFullFolderName, destinationRootOrSubroot, (-1));
% 
% sgtitle(titleString, 'Interpreter','none');
% 
% % Check variable types
