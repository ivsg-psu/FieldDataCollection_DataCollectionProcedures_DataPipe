function fcn_DataPipe_processOneMatFile(thisSourceFullFolderName, thisDestinationFolder, varargin)
%% fcn_DataPipe_processOneMatFile
% Loads CSV text files from a source folder into MATLAB structure, saving
% results in a MAT file within a given destination folder
%
% FORMAT:
%
%      fcn_DataPipe_processOneMatFile(thisSourceFullFolderName, thisDestinationFolder, (figNum));
%
% INPUTS:
%
...
% EXAMPLES:
%
%     See the script: script_test_fcn_DataPipe_processOneMatFile
