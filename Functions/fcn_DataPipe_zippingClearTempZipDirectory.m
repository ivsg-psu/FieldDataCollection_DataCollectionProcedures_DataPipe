function fcn_DataPipe_zippingClearTempZipDirectory(tempZipDirectory, varargin)
% fcn_DataPipe_zippingClearTempZipDirectory checks if the temp zip directory is
% empty and if not, either warns user or deletes contents
%
% FORMAT:
%
...
% INPUTS:
%
%      tempZipDirectory: a string containing the path of the temp zip
%      directory.
%
%      (OPTIONAL INPUTS)
%
...
% EXAMPLES:
%
%     See the script: script_test_fcn_DataPipe_zippingClearTempZipDirectory
...
if 0==flag_max_speed
    if flag_check_inputs
        ...
        % Check the tempZipDirectory to be sure it exists
        fcn_DebugTools_checkInputsToFunctions(tempZipDirectory, 'DoesDirectoryExist');
    end
end
